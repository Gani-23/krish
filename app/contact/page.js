...
const ContactUs = () => {
  return (
    <>
      <Navbar />
      <section className="relative bg-black text-white overflow-hidden pt-24"> {/* Added padding top here */}
          ...
          >
            ...
            <div className="flex flex-col md:flex-row justify-center items-stretch gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-gray-900 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col items-start space-y-4 transform hover:scale-105">
                ...
                <Link href="mailto:saiganesh7989@gmail.com" className="mt-4 text-blue-500 hover:underline">Send an Email</Link>
              </div>
            </div>
          </motion.div>
        </div>
