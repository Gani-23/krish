...
const HomePage = () => {
      ...
      <div>
        ...
        <div className="relative h-screen bg-black text-white overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-full text-center p-8 bg-black bg-opacity-70">
            ...
            {/* New Section: What We're Looking For */}
          </div>
    ...
    {[
      ...
      >
        <motion.img
          src={value.imgSrc}
          alt={value.altText}
          className="w-full md:w-1/2 rounded-lg md:rounded-l-lg mb-4 md:mb-0"
  ...
  <div className="flex justify-center items-center w-full">
    ...
    >
      ...
      <p>
        Collaboration is key to our success. Our dedicated team works
        together to deliver exceptional results and ensure your
        satisfaction.
      </p>
    </motion.div>
  </div>
